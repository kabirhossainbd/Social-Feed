  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: widget.isError ? ColorResources.red : Colors.grey.shade300),
      ),
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: widget.isError ? IconButton(
            ...
            icon: SvgPicture.asset(
              ...
              hoverColor: Colors.transparent,
              focusColor: Colors.transparent,
              icon: Icon(_obscureText ? Icons.visibility_off : Icons.visibility, color: ColorResources.getHintColor(context)),
              onPressed: _toggle)
              : widget.isIcon!
              ? IconButton(
            splashColor: Colors.transparent,
