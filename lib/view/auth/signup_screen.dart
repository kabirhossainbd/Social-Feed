                        ...
                        child: Column(
                          children: [
                            Expanded(
                              child: NotificationListener<OverscrollIndicatorNotification>(
                                ...
                                child: ListView(
                                  children: [
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          child: Padding(
                                            ...
                                            child: SvgPicture.asset(AllImages.cross, height: 16, width: 16,),
                                          ),
                                        ),

                                        Text('Step 1 of 1', style: interRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: ColorResources.grey700),),
                                      ],
                                    ),
                                    ...
                                    Align(alignment: Alignment.center, child: Text("Sign up for Social Feed",style: interBold.copyWith(fontSize: Dimensions.fontSizeLarge,color: ColorResources.black700),)),
                                    ...
                                    if(_isUserEmailError)...[
                                      Row(
                                        children: [
                                          ...
                                          Align(alignment: Alignment.centerLeft,
                                              child:Text('Enter Valid Email',style: interRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.red),)
                                          ),
                                        ],
                                      ),
                                    ],
                                    ...
                                    /// for password
                                    Align(alignment: Alignment.centerLeft,
                                        child:Text("Password",style: interMedium.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.grey700),)
                                    ),
                                    const SizedBox(height: 6,),
                                    CustomTextField(
                                      backgroundColor: ColorResources.COLOR_WHITE,
                                    ...
                                    if(_isPasswordError)...[
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          // const SizedBox(width: 4),
                                          Align(alignment: Alignment.centerLeft,
                                              child:Text('Password Should Be',style: interRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.red),)
                                          ),
                                        ],
                                      ),
                                    ],
                                    ...
                                    /// for password
                                    Align(alignment: Alignment.centerLeft,
                                        child:Text("Confirm Password",style: interMedium.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.grey700),)
                                    ),
                                    const SizedBox(height: 6,),
                                    CustomTextField(
                                      backgroundColor: ColorResources.COLOR_WHITE,
                                    ...
                                    if(_isConPasswordError)...[
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          // const SizedBox(width: 4),
                                          Align(alignment: Alignment.centerLeft,
                                              child:Text('Password confirmation does not match',style: interRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.red),)
                                          ),
                                        ],
                                      ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          // const SizedBox(width: 4),
                                          Align(alignment: Alignment.centerLeft,
                                              child:Text(_isErrorText,style: interRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.red),)
                                          ),
                                        ],
                                      ),
                                    ],
                                ...
                                TextSpan(
                                  children: [
                                    TextSpan(text: 'By continuing, you agree to our',
                                        style: interRegular.copyWith(color: ColorResources.COLOR_GRAY, fontSize: Dimensions.fontSizeExtraSmall)),
                                    TextSpan(
                                      text: 'Terms & Condition',
                                      style: interRegular.copyWith(color: ColorResources.COLOR_PRIMARY, fontSize: Dimensions.fontSizeExtraSmall,),
                                    ),
                              ...
                              CustomButton(
                                  onTap: ()=>
                                      Navigator.push(context, PageTransition(child: const FeedScreen(), type: PageTransitionType.bottomToTop)),
                                  buttonText: 'Continue',
