...
import 'package:social_feed/view/auth/signup_screen.dart';
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Log in for Social Feed",style: interBold.copyWith(fontSize: Dimensions.fontSizeLarge,color: ColorResources.black700),),

                      const SizedBox(height: 75,),
                      Align(alignment: Alignment.centerLeft,
                          child:Text("Email / Username",style: interMedium.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.grey.shade700),)
                      ),
                      ...
                      Align(alignment: Alignment.centerLeft, child: Text("Password",style: interMedium.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.grey.shade700),)),
                      const SizedBox(height: 6,),
                      CustomTextField(
                        borderRadius:  BorderRadius.circular(8),
                        hintText: 'Password',
                        ...
                        child: Align(
                          ...
                          child: Text('Forgot Password',
                            style: interRegular.copyWith(
                              ...
                              color: ColorResources.COLOR_PRIMARY, ), textAlign: TextAlign.left,
                          ),
                        ),
                      ),
                          ...
                          children: [
                            if(_isUserNameEmailError || _isPasswordError)...[
                              Row(
                                children: [
                                  Align(alignment: Alignment.centerLeft,
                                      child:Text("Wrong email address/username or password ",style: interRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: ColorResources.red),)
                                  ),
                                ],
                              ),
                      ...
                      CustomButton(
                          onTap: ()=> Navigator.pushAndRemoveUntil(context, PageTransition(child: const FeedScreen(), type: PageTransitionType.bottomToTop), (route) => false),
                          buttonText: 'Login',
                      ...
                      InkWell(
                          ...
                          child: Container(alignment: Alignment.center,
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  SvgPicture.asset(AllImages.google, height: 32, width: 32 ),
